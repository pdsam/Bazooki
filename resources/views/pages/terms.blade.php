...
<div class="jumbotron section-jumbotron">
    <h1 class="display-4">Terms and Conditions <i class="fas fa-file-contract"></i></h1>
    <hr class="my-2">
    <p class="lead">“The devil is compromise.”</p>
    <p>- Henrik Ibsen</p>
</div>
<div>
    <p>Last updated: 11/05/2020</p>
    <p>Please read these Terms and Conditions ("Terms", "Terms and Conditions") carefully before using
    the Bazooki website.</p>
    ...
    you may be asked to supply certain information relevant to your Purchase.</p>
    <h5>Content</h5>
    <p>Our Service allows you to post, link, store, share and otherwise make available certain information,
    text, graphics, videos, or other material ("Content"). You are responsible for your usage.</p>
    ...
    by Bazooki.</p>
    <p>Bazooki has no control over, and assumes no responsibility for, the content,
    privacy policies, or practices of any third party web sites or services. You further acknowledge and
    agree that Bazooki shall not be responsible or liable, directly or indirectly, for any
